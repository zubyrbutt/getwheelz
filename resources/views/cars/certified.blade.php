				...
				<div class="row">
					...
					<div class="col-lg-5">
						<div class="slider-text">
							...
							<p><span>Offered by: <a href="#">Getwheelz</a></span>
							...
							<div class="short-info">
								<h4>Short Info</h4>
								<p><strong>Model: </strong><a href="#">2019</a> </p>
								<p><strong>Mileage: </strong><a href="#">{{ $car->mileage }} Km</a> </p>
								<p><strong>Engine: </strong><a href="#">{{ $car->engine }}</a></p>
								<p><strong>Transmission: </strong><a href="#">{{ $car->transmission }}</a></p>
							</div><!-- short-info -->
							...
							<div class="contact-with">
								...
								<span class="btn btn-red">
									...
									<a href="{{ route('chat')}}">Chat with seller</a>
								</span>
								@endif
								@else
								<div class="contact-with">
