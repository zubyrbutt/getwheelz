				...
				<div class="row">
						...
						<div id="product-carousel" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators">
								<li data-target="#product-carousel" data-slide-to="0" class="active">
									<img src="{{ asset('storage/'.$bike->image) }}" alt="Carousel Thumb" class="img-fluid">
								</li>
							...
							<div class="carousel-inner" role="listbox">
								...
								<div class="item carousel-item active">
									<div class="carousel-image">
										<!-- image-wrapper -->
										<img src="{{ asset('storage/'.$bike->image) }}" alt="Featured Image" class="img-fluid">
									</div>
								</div><!-- item -->
					...
					<div class="col-lg-5">
						<div class="slider-text">
							<h2>Rs.{{ $bike->price }}</h2>
							<h3 class="title">{{ ucwords($bike->bike_info) }}</h3>
							<p><span>Offered by: <a href="#">{{ ucwords($bike->user->name)}}</a></span>
							<span> Ad ID:<a href="#" class="time"> {{ uniqid() }}</a></span></p>
							<span class="icon"><i class="fa fa-clock-o"></i><a href="#">{{ date('D, d M Y g:i A', strtotime($bike->created_at))}}</a></span>
							<span class="icon"><i class="fa fa-map-marker"></i><a href="#">{{ $bike->city }}, Pakistan</a></span>
							...
							<div class="short-info">
								<h4>Short Info</h4>
								<p><strong>Model: </strong><a href="#">{{ $bike->model }}</a> </p>
								<p><strong>Mileage: </strong><a href="#">{{ $bike->mileage }} Km</a> </p>
								<p><strong>Engine: </strong><a href="#">{{ $bike->engine }}</a></p>
								<p><strong>City: </strong><a href="#">{{ $bike->city }}</a></p>
							</div><!-- short-info -->
							...
							<div class="contact-with">
								...
								<span class="btn btn-red">
									...
									<a href="{{ url('chat/'.$bike->user->id) }}">Chat with seller</a> 
