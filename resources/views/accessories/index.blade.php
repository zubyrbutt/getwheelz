                ...
                <div id="featured-slider-two">
                    <div class="featured">
                        <div class="featured-image">
                            <a href="details.html"><img src="images/car/1.jpg" alt="Image" class="img-fluid"></a>
                        </div>
                    ...
                    <div class="featured">
                        <div class="featured-image">
                            <a href="details.html"><img src="images/car/2.jpg" alt="Image" class="img-fluid"></a>
                        </div>
                    ...
                    <div class="featured">
                        <div class="featured-image">
                            <a href="details.html"><img src="images/car/3.jpg" alt="Image" class="img-fluid"></a>
                        </div>
            ...
            <div class="ad-item row">
                ...
                <div class="item-image-box  col col-lg-5">
                    ...
                    <div class="ad-info">
                        ...
                        <h4 class="item-title"><a href="{{ route('accessories.show', $accessory->id) }}">{{ Str::limit($accessory->title,30) }}</a></h4>
                        <h3 class="item-price">Rs. {{ $accessory->price }}</h3>	
                    </div>						
                </div>	
                ...
                <div class="cars-ads-box colcol-lg-7">
                    <div class="car-info">
                        <ul>
                            <li><i class="fa fa-calendar" aria-hidden="true"></i>Registration City: {{ $accessory->city }}</li>
                            <li><i class="fa fa-tachometer" aria-hidden="true"></i>Mileage: {{ $accessory->condition }}</li>
                            <li><i class="fa fa-external-link" aria-hidden="true"></i>Category: {{ $accessory->category }}</li>
                        </ul>
                    </div>
                    <div class="car-info">
                        <ul>
                            <li><i class="fa fa-eyedropper" aria-hidden="true"></i>Condition: {{ $accessory->condition }}</li>
                    ...
                    <div class="ad-meta">
                        ...
                        <!-- item-info-right -->
                        <div class="user-option pull-right">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ $accessory->city }}"><i class="fa fa-map-marker"></i> </a>
